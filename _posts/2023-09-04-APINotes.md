---
title : APInotes
data : 2023-09-04 10:00:00 +0530
categories: [API,studyNotes]
tags : [TunnelStyle,CURD,REST,style]
---
...
- It use an XML-Centric message formate
...
- URI and query parameter are used to identity  and filter objects
- CURD opertaion mapped to HTTP methods
